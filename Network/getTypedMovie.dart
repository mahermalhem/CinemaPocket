...
Future<List<Movie>> getTypedMovie(String predictedTypes) async {
	print("form getTyped movies $predictedTypes");
	List<Movie> moviesList=[];
	SharedPreferences prefs = await SharedPreferences.getInstance();

	var uri = getMoviesByType;

	uri=uri+'?movieType=$predictedTypes';
